...
describe("company.get", () => {
  ...
  beforeEach(() => { supplyImportMocks.createSupplyImportSession.mockResolvedValue(501); supplyImportMocks.createSupplyImportItem.mockResolvedValue(1); supplyImportMocks.updateSupplyImportSession.mockResolvedValue(undefined); accessoryGroupMocks.getNextAccessoryGroupSequence.mockResolvedValue(3); });
