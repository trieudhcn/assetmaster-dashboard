...
const mocks = vi.hoisted(() => ({ getCompany: vi.fn(), saveCompany: vi.fn(), listHelpGuides: vi.fn(), saveHelpGuide: vi.fn(), createHelpGuideVersion: vi.fn(), listHelpGuideVersions: vi.fn(), recordActivity: vi.fn(), getAssetCategoryByCode: vi.fn(), getAssetCategoryById: vi.fn(), getAssetCategoryByName: vi.fn(), getNextAssetCodeForPrefix: vi.fn(), getNextRetirementCertificateSequence: vi.fn(), createAssetCategory: vi.fn(), countAssetsByCategoryId: vi.fn(), deleteAssetCategory: vi.fn(), updateAssetCategory: vi.fn(), getVendorByName: vi.fn(), getBrandByName: vi.fn(), getBranchByCode: vi.fn(), listActiveAssetsBySerialNumber: vi.fn(), runAssetImportTransaction: vi.fn(), createAsset: vi.fn(), updateAsset: vi.fn(), createAssetImportSession: vi.fn(), updateAssetImportSession: vi.fn(), createAssetImportItem: vi.fn(), createAssetFieldChanges: vi.fn(), getAssetImportSessionById: vi.fn(), listAssetImportSessions: vi.fn(), listAssetImportItems: vi.fn(), getAssetById: vi.fn(), getInventorySupplyByCode: vi.fn(), getInventorySupplyById: vi.fn(), createInventorySupply: vi.fn(), createInventoryMovement: vi.fn(), updateInventorySupply: vi.fn(), listInventorySupplies: vi.fn(), listInventoryMovements: vi.fn(), runInventoryTransaction: vi.fn(), createSupplyIssueSlip: vi.fn(), createSupplyIssueSlipItem: vi.fn(), getNextSupplyIssueSequence: vi.fn(), getSupplyIssueSlipById: vi.fn(), getSupplyIssueSlipItemById: vi.fn(), listInventoryMovementReport: vi.fn(), listSupplyIssueSlipItems: vi.fn(), listSupplyIssueSlips: vi.fn(), updateSupplyIssueSlip: vi.fn(), updateSupplyIssueSlipItem: vi.fn() }));
const supplyImportMocks = vi.hoisted(() => ({ createSupplyImportSession: vi.fn(), createSupplyImportItem: vi.fn(), updateSupplyImportSession: vi.fn(), getSupplyImportSessionById: vi.fn(), listSupplyImportSessions: vi.fn(), listSupplyImportItems: vi.fn() }));
const accessoryGroupMocks = vi.hoisted(() => ({ getNextAccessoryGroupSequence: vi.fn() }));

vi.mock("./db", () => ({ ...supplyImportMocks, ...accessoryGroupMocks,
  createAsset: mocks.createAsset, createAssetCategory: mocks.createAssetCategory, createAssetImportItem: mocks.createAssetImportItem, createAssetImportSession: mocks.createAssetImportSession, createAssetFieldChanges: mocks.createAssetFieldChanges, createAuditItem: vi.fn(), createAuditSession: vi.fn(), createDepartment: vi.fn(), createDivision: vi.fn(), createHandover: vi.fn(), createInventoryMovement: mocks.createInventoryMovement, createInventorySupply: mocks.createInventorySupply, createSupplyIssueSlip: mocks.createSupplyIssueSlip, createSupplyIssueSlipItem: mocks.createSupplyIssueSlipItem, createMaintenanceTicket: vi.fn(), createVendor: vi.fn(), createBrand: vi.fn(), countAssetsByCategoryId: mocks.countAssetsByCategoryId, deleteAssetCategory: mocks.deleteAssetCategory,
  getActiveDepartmentById: vi.fn(), getAssetById: vi.fn(), getAssetCategoryByCode: mocks.getAssetCategoryByCode, getAssetCategoryById: mocks.getAssetCategoryById, getAssetCategoryByName: mocks.getAssetCategoryByName, getBranchByCode: mocks.getBranchByCode, getCompany: mocks.getCompany, getDepartmentByCode: vi.fn(), getDepartmentById: vi.fn(), getDivisionByCode: vi.fn(), getDivisionById: vi.fn(), getHandoverById: vi.fn(), getInventorySupplyByCode: mocks.getInventorySupplyByCode, getInventorySupplyById: mocks.getInventorySupplyById, getMaintenanceTicket: vi.fn(), getNextAssetCodeForPrefix: mocks.getNextAssetCodeForPrefix, getNextRetirementCertificateSequence: mocks.getNextRetirementCertificateSequence, getNextSupplyIssueSequence: mocks.getNextSupplyIssueSequence, getSupplyIssueSlipById: mocks.getSupplyIssueSlipById, getSupplyIssueSlipItemById: mocks.getSupplyIssueSlipItemById, getVendorById: vi.fn(), getVendorByName: mocks.getVendorByName, getBrandById: vi.fn(), getBrandByName: mocks.getBrandByName, listActiveAssetsBySerialNumber: mocks.listActiveAssetsBySerialNumber, listAssets: vi.fn(), listAssetCategories: vi.fn(), listAllAssetCategories: vi.fn(), listAuditItems: vi.fn(), listAuditSessions: vi.fn(), listActivityLogs: vi.fn(), listDepartments: vi.fn(), listAllDepartments: vi.fn(), listDivisions: vi.fn(), listAllDivisions: vi.fn(), listVendors: vi.fn(), listAllVendors: vi.fn(), listBrands: vi.fn(), listAllBrands: vi.fn(), listHandovers: vi.fn(), listHandoversByRecipient: vi.fn(), listInventoryMovements: mocks.listInventoryMovements, listInventoryMovementReport: mocks.listInventoryMovementReport, listInventorySupplies: mocks.listInventorySupplies, listSupplyIssueSlipItems: mocks.listSupplyIssueSlipItems, listSupplyIssueSlips: mocks.listSupplyIssueSlips, listMaintenanceTickets: vi.fn(), listUsers: vi.fn(),
  recordActivity: mocks.recordActivity, runAssetImportTransaction: mocks.runAssetImportTransaction, runInventoryTransaction: mocks.runInventoryTransaction, saveCompany: mocks.saveCompany, listHelpGuides: mocks.listHelpGuides, saveHelpGuide: mocks.saveHelpGuide, createHelpGuideVersion: mocks.createHelpGuideVersion, listHelpGuideVersions: mocks.listHelpGuideVersions, updateAsset: mocks.updateAsset, updateAssetCategory: mocks.updateAssetCategory, updateAssetImportSession: mocks.updateAssetImportSession, updateAuditItem: vi.fn(), updateHandover: vi.fn(), updateInventorySupply: mocks.updateInventorySupply, updateSupplyIssueSlip: mocks.updateSupplyIssueSlip, updateSupplyIssueSlipItem: mocks.updateSupplyIssueSlipItem, updateMaintenanceTicket: vi.fn(), updateDepartment: vi.fn(), updateDivision: vi.fn(), updateVendor: vi.fn(), updateBrand: vi.fn(),
...
describe("company.get", () => {
  ...
  beforeEach(() => { supplyImportMocks.createSupplyImportSession.mockResolvedValue(501); supplyImportMocks.createSupplyImportItem.mockResolvedValue(1); supplyImportMocks.updateSupplyImportSession.mockResolvedValue(undefined); accessoryGroupMocks.getNextAccessoryGroupSequence.mockResolvedValue(3); mocks.getNextRetirementCertificateSequence.mockResolvedValue(1); mocks.getBranchByCode.mockResolvedValue({ id: 1, code: "HO", name: "Head Office", isActive: true }); });
...
describe("asset retirement certificate", () => {
  const adminCaller = () => appRouter.createCaller({ user: { id: 1, openId: "admin", role: "admin", name: "Admin", isActive: true }, req: {}, res: {} } as any);

  beforeEach(() => {
    vi.clearAllMocks();
    mocks.getNextRetirementCertificateSequence.mockResolvedValue(1);
    mocks.createAsset.mockResolvedValue(81);
    mocks.recordActivity.mockResolvedValue(undefined);
  });

  it("creates a yearly TL disposal certificate number from the retirement date", async () => {
    const retiredAt = new Date("2027-04-12T00:00:00.000Z").getTime();
    await expect(adminCaller().assets.create({ assetCode: "TS-THANH-LY-01", name: "Máy in đã hết khấu hao", status: "retired", retiredAt, retirementReason: "Hết khấu hao và không còn nhu cầu sử dụng" })).resolves.toEqual({ id: 81 });
    expect(mocks.getNextRetirementCertificateSequence).toHaveBeenCalledWith(2027);
    expect(mocks.createAsset).toHaveBeenCalledWith(expect.objectContaining({
      retirementCertificateNumber: "TL-2027-001",
      retirementCertificateYear: 2027,
      retirementCertificateSequence: 1,
...
describe("asset Excel import safeguards", () => {
  ...
  it("creates a quantity-managed supply with an opening balance transaction", async () => {
    ...
    mocks.createInventoryMovement.mockResolvedValue(91);
    await expect(adminCaller().supplies.create({ code: "VT-CHUOT", name: "Chuột phổ thông", unit: "Cái", openingQuantity: 20, minimumQuantity: 5, unitCost: 120000, location: "Kho CNTT", categoryId: null, vendorId: null, brandId: null, note: null })).resolves.toEqual({ id: 81 });
    expect(mocks.createInventorySupply).toHaveBeenCalledWith(expect.objectContaining({ code: "VT-CHUOT", stockQuantity: "20", minimumQuantity: "5" }), expect.anything());
  ...
  it("creates an accessory group with an automatically generated PKG code", async () => {
    mocks.getAssetCategoryByName.mockResolvedValue(undefined);
    mocks.createAssetCategory.mockResolvedValue(61);
    await expect(adminCaller().assetCategories.createAccessoryGroup({ name: "Thiết bị ngoại vi" })).resolves.toEqual({ id: 61, code: "PKG-003", name: "Thiết bị ngoại vi" });
    expect(mocks.createAssetCategory).toHaveBeenCalledWith(expect.objectContaining({ name: "Thiết bị ngoại vi", code: "PKG-003", isActive: true }));
  });

  it("rejects changes to a generated accessory code", async () => {
    mocks.getInventorySupplyById.mockResolvedValue({ id: 81, code: "PK-001", name: "Chuột", stockQuantity: "5" });
    await expect(adminCaller().supplies.update({ id: 81, code: "PK-999" })).rejects.toThrow("Mã phụ kiện đã được khóa sau khi tạo mới.");
  });
  ...
  it("records a quantity issue atomically and rejects issues beyond stock", async () => {
    ...
    mocks.createInventoryMovement.mockResolvedValue(92);
    await expect(adminCaller().supplies.move({ supplyId: 81, movementType: "issue", quantity: 2, recipientName: "Phòng Kinh doanh", recipientDepartmentId: null, note: "Cấp phát bổ sung chuột làm việc" })).resolves.toMatchObject({ movementId: 92, stockQuantity: 3, isLowStock: true });
  ...
  it("creates a yearly PK accessory issue slip and links its inventory movement", async () => {
    ...
    mocks.createSupplyIssueSlipItem.mockResolvedValue(201);
