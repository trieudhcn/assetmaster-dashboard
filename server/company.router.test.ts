...
vi.mock("./db", () => ({ ...supplyImportMocks, ...accessoryCodeMocks,
...
describe("company.get", () => {
  ...
  beforeEach(() => { supplyImportMocks.createSupplyImportSession.mockResolvedValue(501); supplyImportMocks.createSupplyImportItem.mockResolvedValue(1); supplyImportMocks.updateSupplyImportSession.mockResolvedValue(undefined); accessoryCodeMocks.getNextInventorySupplySequence.mockResolvedValue(8); });
