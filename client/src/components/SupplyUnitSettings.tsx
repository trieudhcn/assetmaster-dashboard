...
export function SupplyUnitSettings() {
  ...
  return (
    <section data-system-settings-supply-units className="mx-auto mt-5 w-[calc(100%-2rem)] max-w-[1100px] rounded-2xl border border-[#DFE9F0] bg-white p-4 shadow-[0_8px_24px_rgba(16,42,67,0.045)] sm:p-5">
