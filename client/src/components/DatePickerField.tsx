...
export function DatePickerField({ value, onChange, className = "", disabled, placeholder = "Chọn ngày", "aria-label": ariaLabel, "data-purchase-date-picker": purchaseDatePicker }: DatePickerFieldProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent align="start" sideOffset={8} className="z-[180] w-[272px] max-w-[calc(100vw-1rem)] overflow-hidden rounded-xl border border-[#CDE5E5] bg-white p-0 shadow-[0_14px_34px_rgba(16,42,67,0.14)]">
        <div className="flex items-center justify-between border-b border-[#E7EEF3] bg-[#F7FCFC] px-3 py-2.5">
          <div>
