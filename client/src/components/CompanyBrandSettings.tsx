      ...
      <section className="rounded-xl border border-[#DFE9F0] bg-white p-6 shadow-[0_8px_24px_rgba(16,42,67,.045)]">
        ...
        <div className="mt-5 space-y-4">
          ...
          <div>
            ...
            <label className="mt-3 flex cursor-pointer items-start gap-3 rounded-lg border border-[#D7E8E6] bg-[#F8FCFB] p-3 transition hover:border-[#8BCDC6]">
              <input type="checkbox" checked={draft.hideWebsiteOnInternalPdf} onChange={(event) => update("hideWebsiteOnInternalPdf", event.target.checked)} className="mt-0.5 h-4 w-4 rounded border-[#8BCDC6] text-[#0F8C8C] focus:ring-[#0F8C8C]" />
