      ...
      <section className="rounded-xl border border-[#DFE9F0] bg-white p-6 shadow-[0_8px_24px_rgba(16,42,67,.045)]">
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-2">
          ...
          <div>
            ...
            <label className="mt-2 flex cursor-pointer items-center gap-2 text-[11px] font-bold text-[#526779]"><input type="checkbox" checked={draft.hideWebsiteOnInternalPdf} onChange={(event) => update("hideWebsiteOnInternalPdf", event.target.checked)} className="h-4 w-4 rounded border-[#8BCDC6] text-[#0F8C8C] focus:ring-[#0F8C8C]" />Ẩn Website trên mẫu nội bộ</label>
          </div>
