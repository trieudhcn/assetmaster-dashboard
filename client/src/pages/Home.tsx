...
export default function Home() {
  ...
  const dashboardKpis = [
    ...
    { label: "Bảo hành/Sửa chữa", value: String(inventoryAssetRows.filter((asset) => asset.statusType === "maintenance").length), detail: "Cần theo dõi xử lý", subDetail: `Tổng chi phí: ${formatVnd(totalMaintenanceServiceCost)} VNĐ`, icon: Wrench, tone: "amber" },
