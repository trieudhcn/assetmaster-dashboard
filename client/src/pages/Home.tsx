...
export default function Home() {
  ...
  const filteredAssets = useMemo(() => assetRows.filter((asset) => {
    ...
    const branchName = asset.branchId ? branchesQuery.data?.find((branch) => branch.id === asset.branchId)?.name : undefined;
    const matchesBranch = branchFilter === "Tất cả chi nhánh" || branchName === branchFilter;
