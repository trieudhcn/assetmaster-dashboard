...
function PaginatedAssetCatalogPage({ assets, statusCounts, branchCounts, departmentCounts, isFilterDataLoading, query, category, status, department, vendor, brand, warranty, branch, invoice, invoiceOptions, departmentOptions, vendorOptions, brandOptions, branchOptions, onQueryChange, onCategoryChange, onStatusChange, onDepartmentChange, onVendorChange, onBrandChange, onWarrantyChange, onBranchChange, onInvoiceChange, onReset, onCreate, onEdit, onOpenDetail, onOpenQr, onOpenMaintenance, onOpenInvoice, onAssign, canEditSectionLabels = false }: { assets: Asset[]; statusCounts: Record<string, number>; branchCounts: Record<string, number>; departmentCounts: Record<string, number>; isFilterDataLoading: boolean; query: string; category: string; status: string; department: string; vendor: string; brand: string; warranty: string; branch: string; invoice: string; invoiceOptions: string[]; departmentOptions: string[]; vendorOptions: string[]; brandOptions: string[]; branchOptions: string[]; onQueryChange: (value: string) => void; onCategoryChange: (value: string) => void; onStatusChange: (value: string) => void; onDepartmentChange: (value: string) => void; onVendorChange: (value: string) => void; onBrandChange: (value: string) => void; onWarrantyChange: (value: string) => void; onBranchChange: (value: string) => void; onInvoiceChange: (value: string) => void; onReset: () => void; onCreate: () => void; onEdit: (asset: Asset) => void; onOpenDetail: (asset: Asset) => void; onOpenQr: (asset: Asset) => void; onOpenMaintenance: (asset: Asset) => void; onOpenInvoice: (asset: Asset) => void; onAssign: (asset: Asset) => void; canEditSectionLabels?: boolean }) {
