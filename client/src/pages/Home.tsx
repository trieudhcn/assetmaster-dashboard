...
export default function Home() {
  ...
  }, [assetQuery.data, vendorsQuery.data, brandsQuery.data, assetCategoriesQuery.data, branchesQuery.data, assetEmployeesQuery.data, assetDepartmentsQuery.data, repairCostByAssetId]);
