...
function AssetCatalogPage({ assets, totalAssets, statusCounts, branchCounts, query, category, status, department, vendor, brand, warranty, branch, vendorOptions, brandOptions, branchOptions, onQueryChange, onCategoryChange, onStatusChange, onDepartmentChange, onVendorChange, onBrandChange, onWarrantyChange, onBranchChange, onReset, onCreate, onEdit, onOpenDetail, onOpenQr, onOpenMaintenance, onAssign, onExportFilteredAssets, canExportFilteredAssets, isExportingFilteredAssets, onOpenImport, onOpenImportHistory, canEditSectionLabels = false }: { assets: Asset[]; totalAssets: number; statusCounts: Record<string, number>; branchCounts: Record<string, number>; query: string; category: string; status: string; department: string; vendor: string; brand: string; warranty: string; branch: string; vendorOptions: string[]; brandOptions: string[]; branchOptions: string[]; onQueryChange: (value: string) => void; onCategoryChange: (value: string) => void; onStatusChange: (value: string) => void; onDepartmentChange: (value: string) => void; onVendorChange: (value: string) => void; onBrandChange: (value: string) => void; onWarrantyChange: (value: string) => void; onBranchChange: (value: string) => void; onReset: () => void; onCreate: () => void; onEdit: (asset: Asset) => void; onOpenDetail: (asset: Asset) => void; onOpenQr: (asset: Asset) => void; onOpenMaintenance: (asset: Asset) => void; onAssign: (asset: Asset) => void; onExportFilteredAssets: () => void; canExportFilteredAssets: boolean; isExportingFilteredAssets: boolean; onOpenImport: () => void; onOpenImportHistory: () => void; canEditSectionLabels?: boolean }) {
  ...
  const tableMinWidth = 570 + (visibleColumns.holder ? 105 : 0) + (visibleColumns.branch ? 150 : 0) + (visibleColumns.status ? 115 : 0) + (visibleColumns.location ? 145 : 0) + (visibleColumns.value ? 125 : 0);
