...
export function PurchaseContractManagementView() {
  ...
  const openCreate = () => { setEditingId(null); setPaperContractFile(null); setForm(emptyForm); setFormOpen(true); };
  const openEdit = () => {
